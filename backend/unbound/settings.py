"""
Django settings for unbound project.
...
SECRET_KEY = 'django-insecure-e41onmyrl*j6jh647@1^ma$-1q3pmtto1^b*f+!+tl7f12@p8x'
...
# Keep authentication inside the dashboard experience.  Logging out lands on
# the custom allauth login template instead of redirecting through another page.
